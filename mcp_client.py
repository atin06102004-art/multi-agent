...
def _require_env(name: str, value: str | None) -> str: # This creates an environment dictionary for a child process.
...
client = MultiServerMCPClient(
    {
        ...
        "aviationstack": {
            ...
            # So your application effectively runs something similar to:

            # uvx --with mcp<2 aviationstack-mcp

            # This starts the AviationStack MCP server.
        },

        "weather": {
            "transport": "stdio",  # Use the Python interpreter currently running this application.
